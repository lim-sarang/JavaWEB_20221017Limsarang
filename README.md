...
### 2. 추가 구현
 1) 회원가입 입력 창
     ...
     - selected 분반 디폴트 값 지정
     
## 2023년 5월 31일 13주차 홈페이지 수정 완료
### 1. 꾸글.com
 1) 소개 페이지
     - index html 네비게이션 바 추가 및 수정
     - 부트스트랩 템플릿 삽입 및 프로필 수정
     - 음악 및 유튜브 삽입.
         - 유튜브 링크 변경
    - 카카오 API를 활용해 지도 삽입
### 2. 추가 구현
 1) 소개페이지 프로필 이미지 변경
     - 이미지 링크 "https://cdn0.iconfinder.com/data/icons/female-styles/500/woman-reading-bg-1024.png"로 변경
 2) 유튜브 링크 변경
     - embed 뒤에 유튜브 id 변경.
